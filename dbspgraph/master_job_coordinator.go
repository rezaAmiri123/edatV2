...
import (
	...
	"github.com/rezaAmiri123/edatV2/bspgraph"
	"github.com/rezaAmiri123/edatV2/dbspgraph/job"
	"github.com/rezaAmiri123/edatV2/dbspgraph/partition"
	"github.com/rezaAmiri123/edatV2/dbspgraph/proto"
	...
	c.sendToWorker(w, &proto.MasterPayload{
		Payload: &proto.MasterPayload_JobDetails{
			JobDetails: &proto.JobDetails{
				...
				CreatedAt:         timestamppb.New(c.cfg.jobDetails.CreatedAt),
