...
import "github.com/rezaAmiri123/edatV2/bspgraph/message"
...
// ComputeFnnc is a function that a graph instance invokes on each vertex when
// executing a superstep.
type ComputeFnnc func(g *Graph, v *Vertex, msgIt message.Iterator) error
