...
func assertAllProcessed(c *gc.C, payloads []pipeline.Payload) {
	for i, p := range payloads {
		...
		c.Assert(payload.proccessed, gc.Equals, true, gc.Commentf("payload %d not processed", i))
	}
}

var _ pipeline.StageRunner = (*testStage)(nil)
...
var _ pipeline.Source = (*sourceStub)(nil)
...
var _ pipeline.Sink = (*sinkStub)(nil)
...
var _ pipeline.Payload = (*stringPayload)(nil)
...
func (s *stringPayload) MarkAsProcessed()        { s.proccessed = true }
